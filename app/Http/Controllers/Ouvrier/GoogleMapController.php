...
public function OuvrierMap(){
        ...
        $etablissements= Etablissement::withCount('bloc_etablissements')->withCount('etage_etablissements')
     ...
     return  ["ouvrier"=>$ouvrier_camion,"camion"=>$camion,"zone_depot"=>$zone_depot,"etablissement"=>$eta];
}
