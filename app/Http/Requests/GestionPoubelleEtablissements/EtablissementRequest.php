    ...
    public function rules()  {
        if ($this->isMethod('post')) {
            return [
                ...
                'longitude' => 'required',
                'latitude' => 'required',
                'quantite_dechets_plastique' => 'between:0,99999999.99',
                'quantite_dechets_composte'=>   'between:0,99999999.99',
                'quantite_dechets_papier'=>     'between:0,99999999.99',
                'quantite_dechets_canette'=>    'between:0,99999999.99',

                'quantite_plastique_mensuel'=>  'between:0,99999999.99',
                'quantite_papier_mensuel'=>     'between:0,99999999.99',
                'quantite_composte_mensuel'=>   'between:0,99999999.99',
                'quantite_canette_mensuel'=>    'between:0,99999999.99',
            ];
