...
class ZoneTravailSeeder extends Seeder{
    ...
    //         Zone_travail::create([
    //             'region'=> $reg,
    //             'quantite_total_collecte_plastique'=> random_int(1000,1000000),
    //             'quantite_total_collecte_composte'=>random_int(1000,1000000),
    //             'quantite_total_collecte_papier'=> random_int(1000,1000000),
    //             'quantite_total_collecte_canette'=>random_int(1000,1000000),
    //         ]);
    //     }
