<?php
    ...
    use App\Http\Controllers\Ouvrier\PoubellePlusRemplisController;
Route::group(['prefix' => 'auth-ouvrier'], function () {
        Route::group(['middleware'=>['auth:sanctum']], function() {
            Route::group(['middleware' => 'auth:ouvrier'], function() {
                    ...
                    Route::get('/poubelle-plus-remplis-google-map/{id}', [PoubellePlusRemplisController::class, 'PoubellePlusRemplisOuvrierIdEtab']);
